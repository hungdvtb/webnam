                ...
                >
                    <div className="flex items-center justify-between gap-3 border-b border-gold/10 bg-[#fcfaf7] px-5 py-4">
                        <div className="flex items-center gap-3">
                            <span className="material-symbols-outlined rounded-full bg-gold/10 p-2 text-gold">post_add</span>
                            <div>
                                <h3 className="text-[15px] font-black uppercase tracking-[0.12em] text-primary">Dán toàn bộ bài viết</h3>
                                <p className="mt-1 text-[12px] font-medium text-stone/55">
                                    Dán JSON ChatGPT trả về để cập nhật một lượt tiêu đề, SEO, tóm tắt và nội dung HTML.
                                </p>
                            </div>
                        </div>
...
export default BlogPostBulkPasteModal;
