...
class Product extends Model
{
    ...
    protected $fillable = [
        ...
        'meta_title', 'meta_description', 'meta_keywords', 'weight', 'inventory_unit_id', 'supplier_id', 'supplier_product_code', 'video_url', 'additional_info', 'bundle_title', 'site_domain_id'
    ];
