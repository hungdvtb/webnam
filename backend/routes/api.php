...
Route::middleware(['auth:sanctum', 'admin-permission'])->group(function () {
    ...
    Route::get('/quick-replies/bootstrap', [\App\Http\Controllers\Api\QuickReplyController::class, 'bootstrap']);
    Route::get('/quick-replies', [\App\Http\Controllers\Api\QuickReplyController::class, 'index']);
    Route::post('/quick-replies', [\App\Http\Controllers\Api\QuickReplyController::class, 'store']);
    Route::post('/quick-replies/import-pancake', [\App\Http\Controllers\Api\QuickReplyController::class, 'importPancakeExcel']);
    Route::post('/quick-replies/bulk-delete', [\App\Http\Controllers\Api\QuickReplyController::class, 'bulkDestroy']);
    Route::post('/quick-replies/bulk-restore', [\App\Http\Controllers\Api\QuickReplyController::class, 'bulkRestore']);
    Route::get('/quick-replies/gallery', [\App\Http\Controllers\Api\QuickReplyGalleryController::class, 'index']);
    Route::post('/quick-replies/gallery/folders', [\App\Http\Controllers\Api\QuickReplyGalleryController::class, 'storeFolder']);
    Route::put('/quick-replies/gallery/folders/{id}', [\App\Http\Controllers\Api\QuickReplyGalleryController::class, 'updateFolder'])->whereNumber('id');
    Route::delete('/quick-replies/gallery/folders/{id}', [\App\Http\Controllers\Api\QuickReplyGalleryController::class, 'destroyFolder'])->whereNumber('id');
    Route::post('/quick-replies/gallery/images', [\App\Http\Controllers\Api\QuickReplyGalleryController::class, 'uploadImages']);
    Route::post('/quick-replies/gallery/images/copy', [\App\Http\Controllers\Api\QuickReplyGalleryController::class, 'copyImages']);
    Route::post('/quick-replies/gallery/images/send-to-zalo', [\App\Http\Controllers\Api\QuickReplyGalleryController::class, 'sendImagesToZalo']);
    Route::put('/quick-replies/gallery/images/{id}', [\App\Http\Controllers\Api\QuickReplyGalleryController::class, 'updateImage'])->whereNumber('id');
    Route::delete('/quick-replies/gallery/images/{id}', [\App\Http\Controllers\Api\QuickReplyGalleryController::class, 'destroyImage'])->whereNumber('id');
    Route::post('/quick-replies/split-zalo', [\App\Http\Controllers\Api\QuickReplyController::class, 'splitZaloWindows']);
    Route::get('/quick-replies/zalo-mirror/screenshot', [\App\Http\Controllers\Api\QuickReplyController::class, 'zaloMirrorScreenshot']);
    Route::post('/quick-replies/zalo-mirror/click', [\App\Http\Controllers\Api\QuickReplyController::class, 'zaloMirrorClick']);
    Route::post('/quick-replies/zalo-mirror/type', [\App\Http\Controllers\Api\QuickReplyController::class, 'zaloMirrorType']);
    Route::put('/quick-replies/{id}', [\App\Http\Controllers\Api\QuickReplyController::class, 'update'])->whereNumber('id');
    Route::delete('/quick-replies/{id}', [\App\Http\Controllers\Api\QuickReplyController::class, 'destroy'])->whereNumber('id');
    Route::post('/quick-replies/{id}/restore', [\App\Http\Controllers\Api\QuickReplyController::class, 'restore'])->whereNumber('id');
    Route::post('/quick-replies/{id}/duplicate', [\App\Http\Controllers\Api\QuickReplyController::class, 'duplicate'])->whereNumber('id');
    Route::post('/quick-replies/{id}/use', [\App\Http\Controllers\Api\QuickReplyController::class, 'recordUse'])->whereNumber('id');
    Route::post('/quick-replies/{id}/copy-images', [\App\Http\Controllers\Api\QuickReplyController::class, 'copyImages'])->whereNumber('id');
    Route::post('/quick-replies/{id}/send-to-zalo', [\App\Http\Controllers\Api\QuickReplyController::class, 'sendToZalo'])->whereNumber('id');
    Route::post('/quick-reply-topics', [\App\Http\Controllers\Api\QuickReplyController::class, 'storeTopic']);
    Route::put('/quick-reply-topics/{id}', [\App\Http\Controllers\Api\QuickReplyController::class, 'updateTopic'])->whereNumber('id');
    Route::delete('/quick-reply-topics/{id}', [\App\Http\Controllers\Api\QuickReplyController::class, 'destroyTopic'])->whereNumber('id');
...
Route::post('/blog/import-excel', [\App\Http\Controllers\Api\BlogController::class , 'importExcel']);
    ...
    Route::post('/blog/{id}/restore', [\App\Http\Controllers\Api\BlogController::class , 'restore']);
    Route::delete('/blog/{id}/force', [\App\Http\Controllers\Api\BlogController::class , 'forceDelete']);
